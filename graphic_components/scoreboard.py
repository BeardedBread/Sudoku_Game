...
from PyQt5.QtCore import Qt, pyqtProperty, pyqtSignal, QTimer
...
class HighScoreBoard(QWidget):
    """The widget itself. Contains the individual components and manages any cross-component
    signal connections

    Attributes
    ----------
    highscoreSet: pyqtSignal
        Emitted when a high score is set
        """
    highScoreSet = pyqtSignal()
